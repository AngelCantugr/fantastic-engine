...
- [Quick Start Guide](industry-news-aggregator-quickstart.md)
- [MCP Setup Guide](industry-news-aggregator-mcp-setup.md)

## 🔗 Project Location

Source code: `projects/industry-news-aggregator/`
