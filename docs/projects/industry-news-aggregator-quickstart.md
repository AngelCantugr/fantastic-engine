# ⚡ Industry News Aggregator - Quick Start
...
See the [MCP Setup Guide](industry-news-aggregator-mcp-setup.md) for Goose configuration.

## ✏️ Step 3: Customize Your Preferences (1 minute)

Edit `projects/industry-news-aggregator/user-preferences.json`:
...
- Read the full [Overview](industry-news-aggregator.md) for advanced usage
- Check the [MCP Setup Guide](industry-news-aggregator-mcp-setup.md) for detailed configuration
